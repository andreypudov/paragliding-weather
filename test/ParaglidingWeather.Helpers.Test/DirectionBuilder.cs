...
namespace ParaglidingWeather.Helpers.Test
{
    ...
    /// <summary>
    /// Represents a test class for <see cref="ParaglidingWeather.Helpers.DirectionBuilder"/>.
    /// </summary>
    public class DirectionBuilder
    {
        /// <summary>
        /// Represents a test case for <see cref="ParaglidingWeather.Helpers.DirectionBuilder.Get8WindDirection"/> method.
        /// </summary>
        ...
        public void Get8WindDirection(Direction direction, decimal left, decimal right)
        {
            ...
            while (left <= right)
            {
                Assert.AreEqual(direction, ParaglidingWeather.Helpers.DirectionBuilder.Get8WindDirection((double)left));
                left += 0.1M;
            }
        }

        /// <summary>
        /// Represents a test case for <see cref="ParaglidingWeather.Helpers.DirectionBuilder.Get16WindDirection"/> method.
        /// </summary>
        /// <param name="direction">The expected value of direction.</param>
        /// <param name="left">The left boundary of direction in degrees.</param>
        /// <param name="right">The right boundary of direction in degrees.</param>
        ...
        public void Get16WindDirection(Direction direction, decimal left, decimal right)
        {
            ...
            while (left <= right)
            {
                Assert.AreEqual(direction, ParaglidingWeather.Helpers.DirectionBuilder.Get16WindDirection((double)left));
                left += 0.01M;
            }
        }

        /// <summary>
        /// Represents a test case for <see cref="ParaglidingWeather.Helpers.DirectionBuilder.Get32WindDirection"/> method.
        /// </summary>
        /// <param name="direction">The expected value of direction.</param>
        /// <param name="left">The left boundary of direction in degrees.</param>
        /// <param name="right">The right boundary of direction in degrees.</param>
        ...
        public void Get32WindDirection(Direction direction, decimal left, decimal right)
        {
            ...
            while (left <= right)
            {
                Assert.AreEqual(direction, ParaglidingWeather.Helpers.DirectionBuilder.Get32WindDirection((double)left));
                left += 0.001M;
            }
        }
    }
